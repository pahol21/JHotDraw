    ...
    protected JComponent createDisclosedComponent(int state) {
        ...
        switch (state) {
            case 1: 
                ...
                p.add(p2, gbc);
                // Font style buttons
                btn = FontStyleButtonFactory.createFontStyleButton(editor, labels, disposables, BOLD);
                btn.setUI((PaletteButtonUI) PaletteButtonUI.createUI(btn));
                ...
                gbc.insets = new Insets(3, 0, 0, 0);
                p.add(btn, gbc);
                btn = FontStyleButtonFactory.createFontStyleButton(editor, labels, disposables, ITALIC);
                btn.setUI((PaletteButtonUI) PaletteButtonUI.createUI(btn));
                ...
                gbc.insets = new Insets(3, 0, 0, 0);
                p.add(btn, gbc);
                btn = FontStyleButtonFactory.createFontStyleButton(editor, labels, disposables, UNDERLINE);
                btn.setUI((PaletteButtonUI) PaletteButtonUI.createUI(btn));
                ...
                gbc.anchor = GridBagConstraints.WEST;
                p.add(btn, gbc);
                btn = FontStyleButtonFactory.createFontStyleButton(editor, labels, disposables, STRIKETHROUGH);
                btn.setUI((PaletteButtonUI) PaletteButtonUI.createUI(btn));
                btn.putClientProperty("Palette.Component.segmentPosition", "last");
                gbc = new GridBagConstraints();
                gbc.gridy = 2;
